...
//     return null;
// }
// run_activate_plugin( 'theme/crafts_newtheme/plugin/akismet/akismet.php' );

//being install plugins
...
function crafts_newtheme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/plugin/akismet.zip', // The plugin source.
	...
	array(
				'name'     				=> 'bbpress',
				'slug'     				=> 'bbpress',
				'source'   				=> get_stylesheet_directory()  .'/plugin/bbpress.2.5.12.zip',
				'required' 				=> true,
				'version' 				=> '4.12.1',
			)
